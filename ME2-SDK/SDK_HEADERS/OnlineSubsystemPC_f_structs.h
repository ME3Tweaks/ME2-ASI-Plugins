...
{
	TArray< struct FOnlinePlayerScore >                PlayerScores;                                     		// 0x0000 (0x000C) [0x0000000000400182]              ( CPF_Const | CPF_Parm | CPF_OutParm | CPF_NeedCtorLink )
	unsigned long                                      ReturnValue : 1;                                  		// 0x000C (0x0004) [0x0000000000000580] [0x00000001] ( CPF_Parm | CPF_OutParm | CPF_ReturnParm )
};
...
struct UOnlineSubsystemPC_execWriteOnlineStats_Parms
{
	...
	class UOnlineStatsWrite*                           StatsWrite;                                       		// 0x0008 (0x0004) [0x0000000000000080]              ( CPF_Parm )
	unsigned long                                      ReturnValue : 1;                                  		// 0x000C (0x0004) [0x0000000000000580] [0x00000001] ( CPF_Parm | CPF_OutParm | CPF_ReturnParm )
};
...
// Function OnlineSubsystemPC.OnlineSubsystemPC.OnPlayerTalking
// [0x00120000] 
struct UOnlineSubsystemPC_execOnPlayerTalking_Parms
{
	struct FUniqueNetId                                Player;                                           		// 0x0000 (0x0008) [0x0000000000000080]              ( CPF_Parm )
};
